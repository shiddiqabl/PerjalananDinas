        <div id="page-wrapper">
			<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Tujuan Perjalanan Dinas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
            	<div class="col-lg-12">
            		<a href="<?php echo base_url(); ?>tujuan_dinas_controller/tambah" class="btn btn-outline btn-success btn-lg btn-block" role="button">
            			Tambah Data Tujuan Baru 
            		</a>            		
            		<br>
            	</div>
            </div>   
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Daftar Tujuan Perjalanan Dinas Pemerintah Daerah Kabupaten Sragen
                        </div>
                        <!-- /.panel-heading -->
                                	...
                                	<tr>
										...
										<td><!-- <?php echo anchor('tujuan_dinas_controller/edit/'.$d->ID_PROV, 'Edit')?> -->
											<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#detail_modal" 
												...
												data-url="<?php echo base_url();?>tujuan_dinas_controller/edit/"> 
												Detail
											</button> |
											...
											<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#delete_modal" 
												...
												data-url="<?php echo base_url();?>tujuan_dinas_controller/hapus/"> 
												Hapus
											</button> 
										</td>	
                                    </tr>
  			...
  			<div class="modal-dialog" role="document">
    			<div class="modal-content">
      				<div class="modal-header">
        				...
        				<h4 class="modal-title" id="myModalLabel">Hapus Data Tujuan Dinas</h4>
      				</div>
      				<div class="modal-body">
        				Apakah anda yakin menghapus data tujuan dinas Provinsi <b><span id="nama"></span></b> 
